...
def check_phone_number(phone_number):
    '''
    Функция принимает строку, возвращает True при прохождении проверкии её по шаблону(+79239112233) как номер телефона 
    или при значении "-", в остальных случаях возвращает False
    '''
